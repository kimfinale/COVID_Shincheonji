...
NumericVector SS3( nsteps, params["pop3"] );
NumericVector EE3_1( nsteps );
NumericVector EE3_2( nsteps );
NumericVector II3( nsteps );
NumericVector AA3( nsteps );
NumericVector XX3( nsteps );
NumericVector RR3( nsteps );
NumericVector CI3( nsteps ); // cumulative
